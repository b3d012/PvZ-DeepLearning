...
\texttt{PvZ-AI-Harness} v0.2.2. Phase 4 selects a masked actor--critic baseline,
...
Phase 4 consumes that release as a dependency rather than copying its implementation. The dependency is pinned to \texttt{PvZ-AI-Harness v0.2.2}. A local compatibility gate verifies the expected environment contract before experiments proceed.
